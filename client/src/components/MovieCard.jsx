...
const MovieCard = ({movie}) => {
  ...
  return (
    <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-2xl hover:-translate-y-1 transition duration-300 w-56'>
        ...
        src={movie.backdrop_path} alt='' className='rounded-lg h-52 w-full object-cover object-right-bottom cursor-pointer' ></img>
        ...
        <div className='flex items-center justify-between mt-4 pb-3'>
            ...
            className='px-4 py-2 text-xs bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer   bg-pink-700 hover:bg-pink-800 '>
               Buy Tickets
            </button>
